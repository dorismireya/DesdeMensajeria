        ...
        <form role="form">
          ...
          <label>Área de Publicación</label>
            ...
            <div class="input-group margin">
              ...
              <input type="text" id="p_area" class="b_area form-control" readonly="">
              <input type="hidden" id="area_tabla" value="">
              <input type="hidden" id="area_id_tabla" value="">
          ...
          <div class="form-group">
            <label>Título</label>
            <input type="text" class="form-control" placeholder="Ingrese título" id="p_titulo">
            <div class="form-group has-error">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" rows="3" placeholder="Ingrese descripción..." id='p_detalle'></textarea>
            <div class="form-group has-error">
  ...
  <div class="col-md-3">
          ...
          <label>Tipo de Publicación</label>
            <select class="form-control" id="p_tipo" >
              @foreach($tipo_publicaciones as $tipo_publicacion)
                <option value="{{$tipo_publicacion->id_ftp}}">{{$tipo_publicacion->tipo}}</option>
              @endforeach
            </select>
        </div>
      </div>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
            ...
            @foreach($importancias as $importancia)
              <option value="{{$importancia->id_importancia}}">{{$importancia->importancia}}</option>
            @endforeach
      		</select>
          <div class="form-group has-error">
    ...
    <div class="box box-primary box-solid">
      <div class="box-body">
        <!-- Date range -->
        <div class="form-group">
          <label>Lapso de Publicación</label>
            <div class="input-group">
              <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
              </div>
              <input type="text" class="form-control pull-right" id="p_periodo">
            </div><!-- /.input group -->
        </div><!-- /.form group -->
      </div>
    </div>
    ...
    <div class="box box-info box-solid">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Etiqueta" id="p_etiqueta" >
          <div class="form-group has-error">
...
$(document).on('click', '.b_evento', function(){
  ...
  $.ajax({
      ...
      type: 'post',
      url: 'adminPublicacionNew_publicacionAdd',
      data: {
      ...
      success: function(data){
          ...
          if(data.errors){
            ...
            swal("Publicación Creada!", "La publicación "+data.titulo+", fue creada con exito", "success");
          }
...
$(document).on('click','.b_area', function(){
  ...
  $.ajax({
    ...
    type: 'post',
    url: 'adminPublicacionNew_listarFacultad',
    data: {
      '_token': $('input[name=_token]').val(),
    },
    success: function(data){
...
$(document).on('click', '.facultad_list', function() {
  ...
  $.ajax({
    ...
    type: 'post',
    url: 'adminPublicacionNew_listarCarrera',
    data: {
      '_token': $('input[name=_token]').val(),
...
$(document).on('click', '.carrera_list', function() {
  ...
  $.ajax({
    ...
    type: 'post',
    url: 'adminPublicacionNew_listarMateria',
    data: {
      '_token': $('input[name=_token]').val(),
