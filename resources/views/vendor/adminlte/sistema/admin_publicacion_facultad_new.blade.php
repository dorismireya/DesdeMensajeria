...
@section('contentheader_title')
  Nueva Publicación - {{$facultad->facultad}}
@endsection
  ...
  <div class="col-md-9">
     <div class="box box-success box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">Nueva Publicación Para Facultad</h3>
      </div>
      <div class="box-body">
        <form role="form">
          <!-- text input -->
  ...
  $.ajax({
      ...
      success: function(data){
          ...
          if(data.errors){
            ...
            document.location.href= "{!!url('adminPublicacionFacultad/"+data.id_facultad+"');!!}";

            swal("Publicación Creada!", "La publicación "+data.fpublicacion.titulo+", fue creada con exito", "success");
          }
