...
@section('contentheader_title')
  Editar Publicación - {{$facultad->facultad}}
@endsection
  ...
  $.ajax({
      ...
      success: function(data){
          ...
          if(data.errors){
            ...
            swal("Publicación Modifiada! ", "La publicación "+data.titulo+", fue modificada correctamente", "success");
          }
