...
class AdminAllPublicacionController extends Controller
{
    public function index(){
        ...
        return view('adminlte::sistema.admin_all_publicacion', compact('libreria', 'tipo_publicaciones', 'area_publicaciones', 'fpublicaciones', 'tipos', 'importancias', 'old_search', 'tipo_consulta', 'importancia_consulta', 'estado_consulta', 'tabla_consulta' ));
    ...
    public function search(Request $request)
    {
        ...
        return view('adminlte::sistema.admin_all_publicacion', compact('fpublicaciones','tipo_publicaciones', 'area_publicaciones', 'libreria', 'tipos', 'tipo_consulta', 'importancias', 'importancia_consulta', 'old_search', 'tabla_consulta'));
    }
