...
class AdminPublicacionNewController extends Controller
{
    public function index(){
        ...
        return view('adminlte::sistema.admin_publicacion_new', compact('tipo_publicaciones', 'importancias'));
    }

    public function publicacionAdd(Request $request) {
